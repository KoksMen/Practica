...
namespace PR12_1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Выводим информацию о животных и использование делегат
            Console.WriteLine("\n---Product---");
            product.Show();
        ...
        {
            Console.WriteLine("Information is gived...");
        }
    }
